...
_TEXT		SEGMENT BYTE PUBLIC 'CODE' USE16
		...
		@PROLOG	DOSDUPHANDLE
NEWFILEHANDLE	DD	?	; [BP+6]
OLDFILEHANDLE	DW	?	; [BP+10]
		@START	DOSDUPHANDLE
		MOV	BX, [BP].ARGS.OLDFILEHANDLE
		LDS	BP, [BP].ARGS.NEWFILEHANDLE
		MOV	CX, [BP]
		CMP	CX, 0FFFFH
		JE	NEWHANDLE
		XDUP2	[BP].ARGS.OLDFILEHANDLE, CX
		JMP	SKIP
NEWHANDLE:	
		XDUP	[BP].ARGS.OLDFILEHANDLE
SKIP:
		JC	EXIT
		XOR	AX, AX
EXIT:
